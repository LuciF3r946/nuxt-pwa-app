...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "49cc86b7-41fc-4f30-ac9d-7248659e0d00",
...
const _lazy_xx_Pyd = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_xx_Pyd, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_xx_Pyd, lazy: true, middleware: false, method: undefined }
];
