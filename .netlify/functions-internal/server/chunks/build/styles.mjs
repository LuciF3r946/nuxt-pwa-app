...
const styles = {
  "pages/index.vue": () => import('./index-styles.DPnVO4m1.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=0&lang.css": () => import('./index-styles.DPnVO4m1.mjs').then(interopDefault),
